...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       cnn_model = model
       model_label = classifier(test_image, cnn_model)
       # print("\nResults from test_classifier.py\nImage:", test_image, "using model:", cnn_model, "was classified as a:", model_label)
       model_label = model_label.lower().strip()
       # comp = results_dic[key] in model_label
       # print("\nPet label name =", results_dic[key], "Comparison:", comp, "was classified as a:", model_label)
       #print(key)
       #print("#####################################")
