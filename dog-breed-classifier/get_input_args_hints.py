...
def get_input_args():
    ...
    parser.add_argument('--arch', type = list, default = 'resnet', help = 'the cnn model architecture to use' )
    parser.add_argument('--dogfile', type = list,  default = 'dognames.txt', help = 'a dile that contains the valid list of dognames' )
